...
- [x] **فلاتر التصفح (2026-06-10):** سايدبار زي أمازون في صفحات الفئات والبحث — براند + سعر (من/إلى) + تقييم (4/3 فأكثر) + المتوفر بس + **كل خيارات الفاريانتس تلقائياً** (مقاس/لون/وزن بتتجمع من نتائج الصفحة بعدّادات)؛ الفلاتر في الـ URL (قابلة للمشاركة وSSR)؛ الفرز بيحافظ على الفلاتر؛ زر فلاتر للموبايل — مُختبَرة بالأرقام (brand/opt_Color/min/rating)
- [x] **شجرة الفئات (2026-06-10):** parentId في الـ schema + إدارة كاملة في `/admin/categories` (إضافة/تعديل/حذف/فئات فرعية بأي عمق، منع الدواير، منع حذف فئة فيها منتجات أو فروع) — شريط التنقل بيعرض الرئيسية بس، وصفحة الفئة بتعرض الفرعيات chips ومنتجات كل الشجرة تحتها
- [x] **الفاريانتس (2026-06-10):** نظام كامل — أنواع خيارات bilingual (مقاس/لون/وزن، حتى 3 أنواع) + تركيبات لكل واحدة ستوك وسعر اختياري؛ محرر في فورم المنتج بزر "توليد التركيبات"؛ أزرار اختيار في صفحة المنتج؛ السلة والطلبات بتعرض التركيبة snapshot بالعربي والإنجليزي؛ **عدالة الستوك على مستوى التركيبة** (مُختبَرة: شراء آخر قطعة من تركيبة ⇒ المحاولة التانية 409، والإلغاء يرجّع ستوك التركيبة والمنتج)؛ كروت المنتجات بفاريانتس بتعرض "اختر الخيارات" بدل إضافة مباشرة
